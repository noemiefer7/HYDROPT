...
def l1_convert(inputfile, output = None, settings = {},
    ...
    import os, glob, datetime, time, re,sys
...
if __name__ == '__main__':
    [ofiles,setu]=l1_convert('S3B_OL_1_EFR____20230522T095417_20230522T095717_20230522T115313_0179_079_350_1800_PS2_O_NR_003.SEN3', output = None, settings = {},
                             percentiles_compute = True,
                             percentiles = (0,1,5,10,25,50,75,90,95,99,100),
                             verbosity = 5)